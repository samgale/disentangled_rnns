  ...
  def __init__(
    ...
    Args:
      ...
      rng: A numpy random number generator. If not supplied, a new one will be
        created.
    """
    if type(self) is DatasetRNN:  # pylint: disable=unidiomatic-typecheck
      raise TypeError('DatasetRNN cannot be instantiated directly. '
                      'Use subclasses DatasetRNNCategorical, DatasetRNNScalar,'
                      ' or DatasetRNNMixed instead.')
    ##################
    # Error checking #
    ##################
